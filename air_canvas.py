...
# Initializing the colors and thier index
kernel = np.ones((5, 5), np.uint8)

colors = [(255, 0, 0), (0, 255, 0), (0, 0, 255), (0, 255, 255)]
colorIndex = 0

# Assigning arrays to handle colour points and their respective indexes
...
while ret:
    ...
    # Geting hand landmark prediction
    result = hands.process(framergb)

    # Non-Drawing conditions:
    if result.multi_hand_landmarks:  # Checking for number of hands
        landmarks = []
